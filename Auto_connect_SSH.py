...
ssh_info = {  
    'host': 's5.serv00.com',    # 主机地址
    'port': 22,  
    'username': 'kzlcq',       # 你的用户名，别写错了
    'password': 'Yangtianyouzi1234@'       # 你注册的时候收到的密码或者你自己改了的密码
}

WECHAT_ROBOT_KEY  = "R9-jZxzOH42P-rBWMUvt8UjlcfWcXKc2Ze0zWqLtcBs'      # 需要替换成你的企业微信机器人的Webhook Key，参考 https://open.work.weixin.qq.com/help2/pc/14931
